...
const titleArr = "With a focus on results-driven design and cutting-edge technology, we'll help you take your online presence to the next lev".split(" ");
  ...
  return (
    <div className="about">
     <div className="about__container">
          <h2 className="about__title overflow"><span>About</span> <span>01</span></h2>
          ...
          <div className="about__activity">
               <h3><span>2021</span> <span>(Beginning)</span></h3>
               <h2 className="overflow"><span>Founded in 2022</span></h2>
               <h3><span>2023</span> <span>(Active)</span></h3>
          </div>
